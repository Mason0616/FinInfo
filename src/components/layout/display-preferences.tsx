...
type Preferences = { theme: Theme; fontSize: FontSize; sidebar: Sidebar };

const storageKey = 'neon-display-preferences-v1';
const defaults: Preferences = { theme: 'system', fontSize: 'default', sidebar: 'expanded' };
...
function readPreferences(): Preferences {
  try {
    ...
    return { theme: valid(stored.theme, ['light', 'dark', 'system'], defaults.theme), fontSize: valid(stored.fontSize, ['small', 'default', 'large'], defaults.fontSize), sidebar: valid(stored.sidebar, ['expanded', 'compact'], defaults.sidebar) };
